...
urlpatterns = [
    ...
    path('templates/<int:pk>/duplicate/', views.ProjectTemplateDuplicateView.as_view(), name='template-duplicate'),
    path('templates/<int:pk>/favorite/', views.ProjectTemplateFavoriteToggleView.as_view(), name='template-favorite'),
